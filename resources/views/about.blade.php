...
@section('content')
    ...
    <a href="http://duf.dk/tilskud-og-stoette/dufs-initiativstoette/"><img src="{{asset('images/duf-is.png',env('HTTPS'))}}" alt="DUFs intativstøtte logo" class="wign logo-index" width="400"></a>

    <p class="hand"><img src="{{ asset('images/hands-up.png',env('HTTPS')) }}">Ikonerne her på siden er lavet af <a href="http://firehill.dk/">André Jensen</a>
