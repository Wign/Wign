<h1>Welcome to Wign API</h1>
    ...
    <p>
        ...
        JSON<br>
        Returns a list of sign elements of {word}, including the following relevant data: <code>videoID, description, thumb, created_at</code>. Returns empty array if no words is found. Returns a full list of words if no {word} is provided.<br>
        - <code>VideoID</code> to show the video element. <code>description</code> of the video is provided by the "author" of the video. <code>thumb</code> is the thumbnail picture of the video in .png. <code>created_at</code> is the date of creation of the video.
    </p>

    <p>Contact <a href="mailto:tm@wign.dk">Troels Madsen</a> for more informations.</p>